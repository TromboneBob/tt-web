<template>
    <div class="fixed top-0 w-full z-50 flex justify-center">
        <nav class="px-4 sm:px-6 lg:px-8">
            <ul
                class="flex items-center my-4 px-3 text-sm font-medium text-gray-800 rounded-xl shadow-lg bg-white/90 shadow-gray-800/5 ring-1 backdrop-blur dark:bg-neutral-900/90 dark:text-gray-200 dark:ring-white/20 ring-gray-900/5"
            >
